...
// const CoinChart = ({ openPrice, highPrice, lowPrice, currentPrice }) => {
...
//         </div>
//         <CandleVolumeChart volume={volume} openPrice={openPrice} highPrice={highPrice} lowPrice={lowPrice} curretPrice={currentPrice}/>
//       </div>
//     </>
//   )
// }
