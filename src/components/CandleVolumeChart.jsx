...
const CandleVolumeChart = ({ volume, openPrice, highPrice, lowPrice, currentPrice }) => {
  // 여기에 캔들 데이터
  // x축에는 date
  ...
  return (
    <div>
      ...
      <div id="chart-bar">
        {volume && <Chart options={volumeOptions} series={volumeOptions.series} type="bar" height={160} />}
      </div>
    </div>
  );
};
